          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(fontSize: 48, fontWeight: FontWeight.bold, color: _modeColors[_selectedModeIndex]),
              ),
              SizedBox(height: 10),
              ...
              ElevatedButton(
                onPressed: appState.isTimerRunning ? appState.stopTimer : () => appState.startTimer(_modes[_selectedModeIndex] == "Focus"),
